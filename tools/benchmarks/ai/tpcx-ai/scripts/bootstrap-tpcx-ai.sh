...
function download_tpcx_ai_files() {
    ...
    wget https://raw.githubusercontent.com/cloudtik/cloudtik/main/tools/benchmarks/ai/tpcx-ai/confs/default-spark.yaml.template -O $TPCX_AI_HOME/driver/config/default-spark.yaml.template
    wget https://raw.githubusercontent.com/cloudtik/cloudtik/main/tools/benchmarks/ai/tpcx-ai/scripts/configure_default_spark_yaml.py -O $TPCX_AI_HOME/configure_default_spark_yaml.py
