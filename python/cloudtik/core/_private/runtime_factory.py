...
def _import_yarn():
    from cloudtik.runtime.yarn.runtime import YARNRuntime
    return YARNRuntime
...
def _import_mount():
    from cloudtik.runtime.mount.runtime import MountRuntime
    return MountRuntime
...
def _import_redis():
    from cloudtik.runtime.redis.runtime import RedisRuntime
    return RedisRuntime
