...
from cloudtik.core._private.util.core_utils import get_memory_in_bytes
...
DATA_DISK_MOUNT_PATH_PATTERN = os.path.join(DATA_DISK_MOUNT_PATH, CLOUDTIK_DATA_DISK_MOUNT_NAME_PREFIX)
