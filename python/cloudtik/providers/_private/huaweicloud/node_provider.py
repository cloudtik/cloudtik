...
class HUAWEICLOUDNodeProvider(NodeProvider):
    """
    Computing nodes provider for Huawei Cloud.
    ...
    And CLOUDTIK_TAG_NODE_NAME becomes the "name" attribute of the instance
    and also keeps as the tag with the same tag name of the instance.
    """
