...
from cloudtik.providers._private._azure.config import create_azure_workspace, \
    ...
    get_azure_workspace_info, update_azure_workspace, list_azure_storages, list_azure_databases
...
class AzureWorkspaceProvider(WorkspaceProvider):
    ...
    def list_storages(
            self, config: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        return list_azure_storages(config)

    def list_databases(
            self, config: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        return list_azure_databases(config)
